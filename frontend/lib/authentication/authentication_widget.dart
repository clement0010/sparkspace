...
import '../edu_authentication/edu_authentication_widget.dart';
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Hero(
                    tag: FFAppState().logoMainLink,
                    transitionOnUserGestures: true,
                    child: SvgPicture.network(
                      FFAppState().logoMainLink,
                      width: 300,
                      height: 300,
                      fit: BoxFit.cover,
                    ),
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        await Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                            builder: (context) =>
                                                EduAuthenticationWidget(),
                                          ),
                                        );
                                      },
                                      text: 'Sign up with a .edu account',
                                      options: FFButtonOptions(
                                        width: 250,
                                        height: 30,
                                        color: Color(0x00FFFFFF),
